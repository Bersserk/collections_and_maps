...
public class CollectionsMeasuredTime implements MeasuredTime {
    ...
    private double addItemToStart(@NonNull List<Integer> list) {
        double start = System.nanoTime();
        list.add(0);
        return (System.nanoTime() - start);
    }

    private double addItemToMiddle(@NonNull List<Integer> list) {
        double start = System.nanoTime();
        list.add(list.size() / 2, 0);
        return (System.nanoTime() - start);
    }

    private double addItemToEnd(@NonNull List<Integer> list) {
        double start = System.nanoTime();
        list.add(list.size(), 0);
        return (System.nanoTime() - start);
    }

    private double searchByValue(@NonNull List<Integer> list) {
    ...
    private double removingInBeginning(@NonNull List<Integer> list) {
        double start = System.nanoTime();
        list.remove(0);
        return (System.nanoTime() - start);
    }

    private double removingInMiddle(@NonNull List<Integer> list) {
        double start = System.nanoTime();
        list.remove(list.size() / 2);
        return (System.nanoTime() - start);
    }

    private double removingInEnd(@NonNull List<Integer> list) {
        double start = System.nanoTime();
